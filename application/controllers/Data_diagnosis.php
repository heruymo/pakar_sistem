...
class Data_diagnosis extends CI_Controller
{
	...
	public function index()
	{
		if (isset($_GET['tambah'])) {
			...
			$row2 = $row->id_gejala;
			$kondisi = 1;
			$this->load->view('module/module_sp/view_tambah_diagnosis', [
				'model' => $this->model,
				'row1' => $row1,
				'row2' => $row2,
				'kondisi' => $kondisi
		...
		if (isset($_POST['btnSubmit'])) {
			...
			if ($jawaban == 'Ya' && $_POST['cf'] != null) {
				...
				if ($this->model->rules_p1() == TRUE) {
					...
					$this->load->view('module/module_sp/view_hasil_diagnosis', [
	...
	public function select()
	{
		if (isset($_POST['kunci'])) {
			...
			$this->load->view('module/module_sp/view_data_diagnosis', [
				'data' => $data,
