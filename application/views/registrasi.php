        ...
        <div class="row justify-content-center">
            <div class="col-md-5">
                ...
                <div class="card-group clearfix animated bounceIn">
                    <div class="card p-4">
                        <div class="card-body">
                            <form class="form-horizontal" action="<?php echo base_url('login/regristrasi') ?>" method="post">
                                ...
                                <div class="row">
                                    <div class="col-3">
                                        <button class="btn btn-primary px-3 " id="appendedInput" type="submit" name="btnSubmit">Login</button>
                                    </div>
                                    <button class="btn btn-danger" id="appendedInput" type="submit" name="<?php echo base_url('login/regristrasi') ?>">Registrasi</button>
                                </div>
                        </div>
                        </form>
                    </div>
